...
<!------------------------------->
                   ...
                   <!------------------------------->
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-username" name="username" class="form-control" placeholder="aaa" value=" <?php echo $_SESSION['contactperson']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Email address</label>
                        <input type="email" id="input-email" name="email" class="form-control" placeholder="pradeep@example.com" value=" <?php echo $_SESSION['email']; ?>">
                          <input type="text" style="display:none;" id="input-type" name="type" class="form-control" placeholder="pradeep@example.com" value="<?php echo $_SESSION['type']; ?>">
                          <input type="text" style="display:none;" id="input-type" name="pass" class="form-control" placeholder="pradeep@example.com" value="<?php echo $_SESSION['pass']; ?>">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input id="input-address" name="address" class="form-control" placeholder="Home Address" value=" <?php echo $_SESSION['address']; ?>" type="text">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-city" name="city" class="form-control" placeholder="City" value=" <?php echo $_SESSION['city']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="form-group">
                        ...
                        <input type="text" id="input-postal-code" name="postcode" class="form-control" placeholder="Postal code" value=" <?php echo $_SESSION['postcode']; ?>">
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="pl-lg-4">
                  <div class="form-group">
                    ...
                    <textarea rows="4" class="form-control" placeholder="A few words about you ..." name="comment"><?php echo $_SESSION['comment']; ?></textarea>
                  </div>
                </div>
                <center><input type="submit" class="btn btn-info" name="updt_submit" value="Update Profile"  /></center>
              </form>
            </div>
          </div>
        </div>
