...
<div class="row">
    ...
    border: 0;">
        ...
        <a class="dropdown-item" style = "background-color: #fff;border-color:#fff;" href="https://api.whatsapp.com/send?text=<?php echo $jtitle .' - ' .$jcompany; ?> https://innerworkindia.com/job_details.php?id=<?php echo $jid;?>"
data-action="share/whatsapp/share"  target= "_blank"><img src="img/wp.jpg" style="height :30px"><p style="display: inline;color:black;font-size: 14px;">  Whatsapp</p></a>
        <a class="dropdown-item" style = "background-color: #fff;border-color:#fff;" href="http://www.linkedin.com/shareArticle?mini=true&url=https://innerworkindia.com/job_details.php?id=<?php echo $jid; ?>" target= "_blank"><img src="img/link.png" style="height :30px"><p style="display: inline;color:black;font-size: 14px;">  Linkedin</p></a>
        </div>
													</div>
...
<!-- 											<div class="details-section fixht">
 -->
											<div class="details-section ">
													    ...
													    <a style="color:blue" href="mailto:<?php echo $email ?>"><b><?php echo $email ?></b></a>
											</div>
										</div>
