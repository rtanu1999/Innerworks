...
<section id="services">
    <div class="container-fluid padNone">
        ...
        <div class="col-md-3">
            <a href="startup-support">
                <div class="Box" style="background: #000;">
                    <h2 style="color:#fff;"><img src="img/icons/startupSupport.jpg" alt="management - Innerwork"> <span style="color:#fff;">Startup Support</span></h2>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="aboutCompany">
                    <img src="img/aboutUsImg.png"  alt="about Innerwork">
                </div>
            </div>
        </div>
    </div>
...
<section id="tagline">
    <div class="container">
        <span>WE DESIGN SOLUTIONS FOR YOUR BUSINESS TO BE THE BEST</span>
        <h2>Start your career soaring high...
            Reach for us</h2>
        <p>We adopt a systematic and structured approach to meet the HR needs of our clients, combined with a very effective form of matrix evaluation process. The result is effective services that are On Plan, On Time, and On Budget. And our psychometric evaluation processes make sure our candidates and services are the best.</p>
