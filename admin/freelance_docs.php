            ...
            if(isset($_GET['id']))
{
 ...
 $stmt = $conn->prepare('select * from freelancer where userid = ?');
                ...
                <table class="tbl">
                    ...
                    foreach($data as $row)
                    {
                        ...
                        <tr id="<?php echo $row['userid']; ?>">
                            <td><?php echo $cnt; ?></td>
                            <td>
                                <?php echo "<a href=\"https://innerworkindia.com/freelancerdocuments/aadhar/{$adhar_file}\">"; // 12-05-2020?>
                                <?php echo $row['adhar']; ?>;
                                </a>
                            </td>
                            <td>
                                <?php echo "<a href=\"https://innerworkindia.com/freelancerdocuments/PAN/{$pan_file}\">"; // 12-05-2020?>
                                <?php echo $row['pan']; ?>;
                                </a>
                            </td>
                            <td>
                                <?php echo "<a href=\"https://innerworkindia.com/freelancerdocuments/CV/{$cv_file}\">"; // 12-05-2020?>
                                <?php echo $row['cv']; ?>;
                                </a>
                            </td>
