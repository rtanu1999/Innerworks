	 ...
	 if(isset($_POST["exp"]))
	{
        ...
        <div class="col-sm-12 col-xs-9">
            ...
            <div class="text-right">
                ...
                <div class="job-share">
                    <a href="#" title="Share this Internship" data-etracking="true" data-ecategory="job_card_share_icon" style="width:100%;color: #ffc114;background-color:#fff;border: 0px;"><i class="fa fa-share-alt"></i></a>
