<?php include "CommonFiles.php"?>
    ...
    <link rel="stylesheet" href="css/collage.css"><section id="headerBtm">
        ...
        <nav class="navbar navbar-inverse" role="navigation"> <!-- navbar-fixed-top -->
            <div class="container-fluid-padNone">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index" title="Innerer Work"><img src="img/logo.png" alt="Innerer Work" class="logo"></a>
                    <h6 class="inner"><font face = "Monotype Corsiva" size = 10">Innerwork</font></h6>
                </div>
